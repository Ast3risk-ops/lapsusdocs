...
<ParamField path="name" type="string" default="Lapsus Launcher" required>
  Name of your company as it will show in the panel.
</ParamField>
<ParamField path="logo" type="array" required>
  The logo as shown in the panel. Contains a URL parameter.
  <Expandable title="options">
   <ParamField path="url" type="string" required default='/assets/img/logo_background.png'>
     A path or URL of an image
   </ParamField> 
  </Expandable>
</ParamField>