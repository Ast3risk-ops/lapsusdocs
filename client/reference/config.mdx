...
| `database`       | `sqlite://database.sqlite` | The path to an SQLite database file, starting with <code>sqlite://</code><br /><br /> ℹ️ The file will be created if it does not exist |
